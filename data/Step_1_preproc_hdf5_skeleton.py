...
src = r"/home/tim/Documents/RISE19/data/Data_processed/Train"
dst = r"/home/tim/Documents/RISE19/data/Data_processed/Train_hdf5"
def main():
    files_train = glob(src+"/batch_*.zip")
    files_valid = glob(src+"/batch_*.zip")
...
def load_gzip(path):
    ...
    video, skeleton_feature, label, sk_trajectory = load(file, allow_pickle=True)
    file.close()
